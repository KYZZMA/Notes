...
public class NotesListAdapter extends RecyclerView.Adapter <NotesViewHolder>{
    ...
    public NotesListAdapter(Context context, List<Notes> list, NotesClick listen) {
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
        ...
        if (list.get(position).isPinned()){
            holder.imageView_pin.setImageResource(R.drawable.pin2_icon);
        } else {
        ...
        holder.notes_conteiner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                listen.onClick(list.get(holder.getAdapterPosition()));
            }
        });
        holder.notes_conteiner.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                listen.onLongClick(list.get(holder.getAdapterPosition()), holder.notes_conteiner);
                return true;
            }
        });
    }
    ...
    public void filterList (List<Notes> filteradList){
        list = filteradList;
